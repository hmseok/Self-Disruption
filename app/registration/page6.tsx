...
// 🛠️ [유틸리티] 데이터 정제 함수 (AI가 점을 찍거나 콤마를 넣어도 해결)
...
export default function RegistrationListPage() {
  ...
  // 🚀 [핵심 업그레이드] 대량 등록 핸들러 (만능 수신 + 데이터 청소)
      ...
      for (let i = 0; i < files.length; i++) {
          ...
          try {
              ...
              const insertPayload = {
                  ...
                  purchase_price: cleanNumber(result.purchase_price),
