  ...
  const handleBulkUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      for (let i = 0; i < files.length; i++) {
          ...
          try {
              ...
              // 🆕 4. [트림 자동 저장] 여기가 핵심입니다.
              // AI가 가져온 트림 정보를 즉시 DB에 저장합니다.
              ...
              const insertPayload = {
                  ...
                  brand: '기타',
                  model: detectedModel, // 트림명 제외한 순수 모델명
      ...
      alert('등록 완료! 상세 페이지에서 바로 트림을 선택할 수 있습니다.')
    ...
    <div className="max-w-7xl mx-auto py-10 px-6 animate-fade-in relative">
      <div className="flex justify-between items-center mb-6">
        <div>
            ...
            <p className="text-sm text-gray-500 mt-1">등록증을 올리면 차종, 제원, 트림 정보를 자동으로 수집하여 저장합니다.</p>
        </div>
