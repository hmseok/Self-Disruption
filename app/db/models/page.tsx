...
// 차량 시세 DB는 산출 기준 관리 > 감가기준 탭으로 통합되었습니다
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center max-w-md">
        ...
        <h2 className="text-lg font-bold text-gray-900 mb-2">차량 시세 DB</h2>
        <p className="text-xs text-gray-500 mb-4">
          차량 시세 관리는 <strong>산출 기준 관리</strong> 페이지의 감가기준 탭으로 통합되었습니다.
        </p>
        <button
