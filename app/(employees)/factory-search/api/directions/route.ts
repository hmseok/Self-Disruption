...
// ─────────────────────────────────────────────────────────────────
// 카카오 모빌리티 Directions API 프록시
//   /api/directions?origin=lng,lat&destination=lng,lat
//
// 카카오 콘솔 → 제품 설정 → 카카오 내비 활성화 + REST API 키 필요
// 응답: { success, data: { distanceMeters, durationSeconds, tollFare, taxiFare } }
// ─────────────────────────────────────────────────────────────────
