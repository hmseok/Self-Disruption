    ...
    <div style={{ padding: '16px 20px', width: '100%' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', position: 'relative' }}>
          ...
          {/* CX-KPI-21 — 알리고 SMS 문자 배포 (배정 없으면 비활성) */}
          <button
            type="button"
            ...
            style={{
              ...BTN.lg,
              background: detail.assignments.length === 0 ? COLORS.bgGray : COLORS.bgBlue,
              color: detail.assignments.length === 0 ? COLORS.textMuted : COLORS.primary,
              border: `1px solid ${detail.assignments.length === 0 ? COLORS.borderFaint : COLORS.borderBlue}`,
