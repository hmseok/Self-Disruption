...
function DetailInner({ id }: { id: string }) {
  ...
  const [externalOpen, setExternalOpen] = useState(false)  // PR-2QQ-b
            ...
            {moreOpen && (
              <div style={{
                ...
                <MenuItem
                  icon="🔒"
                  label="외부 직원 일정"
                  sub="엑셀 업로드 → manual_lock (자동 생성 보존)"
                  onClick={() => { setMoreOpen(false); setExternalOpen(true) }}
                />
