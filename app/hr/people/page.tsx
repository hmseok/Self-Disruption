...
// ============================================
// /hr/people — 인력 마스터 (PR-A1, 2026-05-05)
// 직원 (profiles) 마스터 + 모달 통합 (기본정보 / 급여 / 권한)
//   - 부서/직급/초대 → /hr/org 로 분리됨
//   - 페이지 권한 일괄 편집 (master-detail) → 제거 — 모달 안 § 권한 사용
// master/admin 만 접근 가능
// ============================================
...
export default function HRPeoplePage() {
  ...
  return (
    <div className="page-bg">
      ...
      {/* 안내 — 부서/직급/초대 는 /hr/org 로 이동 */}
      <div style={{ background: 'rgba(59,130,246,0.06)', border: '1px solid rgba(59,130,246,0.2)', borderRadius: 10, padding: '8px 14px', fontSize: 12, color: '#2563eb', marginBottom: 12 }}>
        💡 부서 · 직급 · 초대 관리는 「조직 마스터」 페이지로 이동했습니다.
      </div>
