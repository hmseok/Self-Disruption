-- 024: 렌트가 산출 → 장기렌터카 견적 이름 변경 + 단기렌터카 견적 모듈 분리
-- ====================================================================
...
SELECT '단기렌터카 견적', '/quotes/short-term', 'Wrench', '단기대차 서비스 요금 조회, 견적 작성, 턴키 렌터 계약 관리'
...
JOIN system_modules sm ON sm.path = '/quotes/short-term'
